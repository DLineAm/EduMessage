...
namespace EduMessage.Utils
{
    public class RichTextBoxExtension
    {
        public static readonly DependencyProperty PlainTextProperty =
            DependencyProperty.RegisterAttached("PlainText", typeof(string),
                typeof(RichTextBoxExtension), new PropertyMetadata(null, OnPlainTextChanged));
  ...
  static readonly DependencyProperty RichEditChangeStateHelperProperty =
    ...
    typeof(RichEditChangeStateHelper), typeof(RichTextBoxExtension), null);
    ...
    richEdit.TextChanged += (sender, args) =>
    {
      ...
      switch (state)
      {
        case RichEditChangeState.Idle:
          string text = null;
          richEdit.Document.GetText(Windows.UI.Text.TextGetOptions.IncludeNumbering, out text);
